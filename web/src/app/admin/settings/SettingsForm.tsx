  ...
  return (
    <div className="flex flex-col pb-8">
      ...
      <Checkbox
        ...
        sublabel="If set, users will not be required to sign in to use Zakk."
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              anyone to use Zakk without signing in.
            </p>
      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Zakk to retain chat messages. Leaving this field empty will cause Zakk to never delete chat messages."
