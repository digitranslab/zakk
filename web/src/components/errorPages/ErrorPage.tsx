  ...
  return (
    <ErrorPageLayout>
      ...
      <div className="space-y-4 text-gray-600 dark:text-gray-300">
        <p>
          It seems there was a problem loading your Zakk settings. This could be
        ...
        <p>
          ...
          <a
            ...
            href="https://docs.digi-trans.org/introduction?utm_source=app&utm_medium=error_page&utm_campaign=config_error"
            target="_blank"
