...
def _get_fence_validation_block_expiration() -> int:
    ...
    try:
        beat_multiplier = ZakkRuntime.get_beat_multiplier()
    except Exception:
...
def _is_external_doc_permissions_sync_due(cc_pair: ConnectorCredentialPair) -> bool:
    ...
    source_sync_period *= int(ZakkRuntime.get_doc_permission_sync_multiplier())
...
def try_creating_permissions_sync_task(
    ...
    lock: RedisLock = r.lock(
        ZAKK_REDIS_FUNCTION_LOCK_PREFIX + "try_generate_permissions_sync_tasks",
