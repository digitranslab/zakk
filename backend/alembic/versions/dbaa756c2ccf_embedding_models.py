...
from zakk.configs.model_configs import ASYM_PASSAGE_PREFIX
from zakk.configs.model_configs import ASYM_QUERY_PREFIX
from zakk.configs.model_configs import DOC_EMBEDDING_DIM
from zakk.configs.model_configs import DOCUMENT_ENCODER_MODEL
from zakk.configs.model_configs import NORMALIZE_EMBEDDINGS
from zakk.configs.model_configs import OLD_DEFAULT_DOCUMENT_ENCODER_MODEL
from zakk.configs.model_configs import OLD_DEFAULT_MODEL_DOC_EMBEDDING_DIM
from zakk.configs.model_configs import OLD_DEFAULT_MODEL_NORMALIZE_EMBEDDINGS
from zakk.db.enums import EmbeddingPrecision
from zakk.db.models import IndexModelStatus
from zakk.db.search_settings import user_has_overridden_embedding_model
...
def _get_new_default_embedding_model() -> IndexingSetting:
    return IndexingSetting(
        ...
        index_name=f"zakk_chunk_{clean_model_name(DOCUMENT_ENCODER_MODEL)}",
        multipass_indexing=False,
        enable_contextual_rag=False,
        api_url=None,
    )
