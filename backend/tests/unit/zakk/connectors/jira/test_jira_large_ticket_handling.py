...
from zakk.connectors.jira.connector import _perform_jql_search
from zakk.connectors.jira.connector import process_jira_issue
...
def mock_jira_api_version() -> Generator[Any, Any, Any]:
    with patch("zakk.connectors.jira.connector.JIRA_API_VERSION", "2"):
        yield
...
@patch("zakk.connectors.jira.connector.JIRA_CONNECTOR_MAX_TICKET_SIZE", 50)
