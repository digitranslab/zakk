...
def test_single_text_file_with_metadata(
    ...
    assert doc.sections[0].link == "https://digi-trans.org"
    assert doc.semantic_identifier == "my display name"
    assert doc.primary_owners[0].display_name == "wenxi@digi-trans.org"  # type: ignore
    assert doc.secondary_owners[0].display_name == "founders@digi-trans.org"  # type: ignore
...
def test_two_text_files_with_zip_metadata(
    ...
    zip_metadata = {
        "file1.txt": {
            ...
            "link": "https://digi-trans.org/1",
            "primary_owners": ["alice@digi-trans.org"],
            "secondary_owners": ["bob@digi-trans.org"],
            "doc_updated_at": "2022-02-02T00:00:00Z",
        },
        "file2.txt": {
            "filename": "file2.txt",
            "file_display_name": "display 2",
            "link": "https://digi-trans.org/2",
            "primary_owners": ["carol@digi-trans.org"],
            "secondary_owners": ["dave@digi-trans.org"],
    ...
    assert doc1.sections[0].link == "https://digi-trans.org/1"
    assert doc1.semantic_identifier == "display 1"
    assert doc1.primary_owners[0].display_name == "alice@digi-trans.org"  # type: ignore
    assert doc1.secondary_owners[0].display_name == "bob@digi-trans.org"  # type: ignore
    assert doc1.doc_updated_at == datetime(2022, 2, 2, 0, 0, 0, tzinfo=timezone.utc)
    assert doc2.sections[0].text == "File 2 content"
    assert doc2.sections[0].link == "https://digi-trans.org/2"
    assert doc2.semantic_identifier == "display 2"
    assert doc2.primary_owners[0].display_name == "carol@digi-trans.org"  # type: ignore
    assert doc2.secondary_owners[0].display_name == "dave@digi-trans.org"  # type: ignore
