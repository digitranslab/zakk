...
def jira_connector() -> JiraConnector:
    connector = JiraConnector(
        jira_base_url="https://zakkai.atlassian.net",
        project_key="AS",
...
def test_jira_connector_basic(reset: None, jira_connector: JiraConnector) -> None:
    ...
    # Check task
    assert story.id == "https://zakkai.atlassian.net/browse/AS-3"
    ...
    assert story.metadata == {
        ...
        "reporter_email": "chris@digi-trans.org",
        "assignee_email": "chris@digi-trans.org",
    ...
    assert section.link == "https://zakkai.atlassian.net/browse/AS-3"

    # Check epic
    assert epic.id == "https://zakkai.atlassian.net/browse/AS-4"
    ...
    assert epic.metadata == {
        ...
        "reporter_email": "founders@digi-trans.org",
        "assignee_email": "chris@digi-trans.org",
        "project_name": "DailyConnectorTestProject",
        "project": "AS",
        "key": "AS-4",
    ...
    assert section.link == "https://zakkai.atlassian.net/browse/AS-4"
