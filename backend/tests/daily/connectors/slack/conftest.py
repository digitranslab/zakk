...
def slack_connector(
    ...
    slack_credentials_provider: ZakkStaticCredentialsProvider,
...
@pytest.fixture
def slack_credentials_provider() -> ZakkStaticCredentialsProvider:
    CI_ENV_VAR = "SLACK_BOT_TOKEN"
    LOCAL_ENV_VAR = "ZAKK_BOT_SLACK_BOT_TOKEN"
    ...
    return ZakkStaticCredentialsProvider(
