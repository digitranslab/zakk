...
def process_question(zakk_url: str, question: str, api_key: str | None) -> None:
    message_endpoint = zakk_url + "/api/chat/send-message"

    chat_session_id = create_new_chat_session(zakk_url, api_key)
...
if __name__ == "__main__":
    ...
    process_question(
        zakk_url=args.zakk_url, question=args.test_question, api_key=api_key
    )
