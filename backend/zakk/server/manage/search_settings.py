...
from zakk.context.search.models import SearchSettingsCreationRequest
...
from zakk.db.search_settings import create_search_settings
from zakk.db.search_settings import delete_search_settings
from zakk.db.search_settings import get_current_search_settings
from zakk.db.search_settings import get_embedding_provider_from_provider_type
...
from zakk.document_index.document_index_utils import get_multipass_config
from zakk.document_index.factory import get_default_document_index
from zakk.file_processing.unstructured import delete_unstructured_api_key
from zakk.file_processing.unstructured import get_unstructured_api_key
from zakk.file_processing.unstructured import update_unstructured_api_key
from zakk.natural_language_processing.search_nlp_models import clean_model_name
from zakk.server.manage.embedding.models import SearchSettingsDeleteRequest
from zakk.server.manage.models import FullModelVersionResponse
from zakk.server.models import IdReturn
...
def set_new_search_settings(
    ...
    if search_settings_new.index_name is None:
        ...
        index_name = f"zakk_chunk_{clean_model_name(search_settings_new.model_name)}"
        if (
