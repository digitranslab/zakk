...
from zakk.configs.constants import POSTGRES_CELERY_WORKER_KG_PROCESSING_APP_NAME
...
celery_app.config_from_object("zakk.background.celery.configs.kg_processing")
