...
from zakk.configs.constants import POSTGRES_CELERY_WORKER_DOCFETCHING_APP_NAME
...
celery_app.config_from_object("zakk.background.celery.configs.docfetching")
...
celery_app.autodiscover_tasks(
    [
        "zakk.background.celery.tasks.docfetching",
    ]
)
