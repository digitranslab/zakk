...
beat_task_templates: list[dict] = [
    {
        ...
        "task": ZakkCeleryTask.CHECK_KG_PROCESSING,
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.CHECK_KG_PROCESSING_CLUSTERING_ONLY,
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.CHECK_FOR_INDEXING,
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.CHECK_FOR_CHECKPOINT_CLEANUP,
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.CHECK_FOR_VESPA_SYNC_TASK,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": ZakkCeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.CHECK_FOR_USER_FILE_FOLDER_SYNC,
        "schedule": timedelta(
            days=1
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.CHECK_FOR_PRUNING,
        "schedule": timedelta(seconds=20),
        "options": {
            "priority": ZakkCeleryPriority.MEDIUM,
            "expires": BEAT_EXPIRES_DEFAULT,
    ...
    },
    {
        ...
        "task": ZakkCeleryTask.MONITOR_BACKGROUND_PROCESSES,
        ...
        [
            {
                ...
                "task": ZakkCeleryTask.CHECK_FOR_DOC_PERMISSIONS_SYNC,
            ...
            },
            {
                ...
                "task": ZakkCeleryTask.CHECK_FOR_EXTERNAL_GROUP_SYNC,
                "schedule": timedelta(seconds=20),
                "options": {
                    "priority": ZakkCeleryPriority.MEDIUM,
                    "expires": BEAT_EXPIRES_DEFAULT,
    ...
    beat_task_templates.append(
        {
            ...
            "task": ZakkCeleryTask.CHECK_FOR_LLM_MODEL_UPDATE,
...
def make_cloud_generator_task(task: dict[str, Any]) -> dict[str, Any]:
    ...
    cloud_task["options"] = {}
    cloud_task["options"]["priority"] = ZakkCeleryPriority.HIGHEST
    cloud_task["options"]["expires"] = BEAT_EXPIRES_DEFAULT

    # settings dependent on the original task
    cloud_task["name"] = f"{ZAKK_CLOUD_CELERY_TASK_PREFIX}_{task['name']}"
    cloud_task["task"] = ZakkCeleryTask.CLOUD_BEAT_TASK_GENERATOR
    cloud_task["kwargs"] = {}
...
# the name attribute must start with ZAKK_CLOUD_CELERY_TASK_PREFIX = "cloud" to be seen
# by the DynamicTenantScheduler as system wide task and not a per tenant task
beat_cloud_tasks: list[dict] = [
    # cloud specific tasks
    {
        "name": f"{ZAKK_CLOUD_CELERY_TASK_PREFIX}_monitor-alembic",
        "task": ZakkCeleryTask.CLOUD_MONITOR_ALEMBIC,
        "schedule": timedelta(hours=1),
        "options": {
            "queue": ZakkCeleryQueues.MONITORING,
    ...
    {
        "name": f"{ZAKK_CLOUD_CELERY_TASK_PREFIX}_monitor-celery-queues",
        "task": ZakkCeleryTask.CLOUD_MONITOR_CELERY_QUEUES,
        "schedule": timedelta(seconds=30),
        "options": {
            "queue": ZakkCeleryQueues.MONITORING,
            "priority": ZakkCeleryPriority.HIGH,
    ...
    {
        "name": f"{ZAKK_CLOUD_CELERY_TASK_PREFIX}_check-available-tenants",
        "task": ZakkCeleryTask.CLOUD_CHECK_AVAILABLE_TENANTS,
    ...
    {
        "name": f"{ZAKK_CLOUD_CELERY_TASK_PREFIX}_monitor-celery-pidbox",
        "task": ZakkCeleryTask.CLOUD_MONITOR_CELERY_PIDBOX,
        ...
        [
            {
                ...
                "task": ZakkCeleryTask.MONITOR_CELERY_QUEUES,
            ...
            },
            {
                ...
                "task": ZakkCeleryTask.MONITOR_PROCESS_MEMORY,
                "schedule": timedelta(minutes=5),
                "options": {
                    "priority": ZakkCeleryPriority.LOW,
                    "expires": BEAT_EXPIRES_DEFAULT,
            ...
            },
            {
                ...
                "task": ZakkCeleryTask.CELERY_BEAT_HEARTBEAT,
                "schedule": timedelta(minutes=1),
                "options": {
                    "priority": ZakkCeleryPriority.HIGHEST,
                    "expires": BEAT_EXPIRES_DEFAULT,
                    "queue": ZakkCeleryQueues.PRIMARY,
                },
            },
        ]
    )
