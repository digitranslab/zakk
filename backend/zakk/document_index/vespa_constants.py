...
# zakk_chunk below is defined in vespa/app_configs/schemas/zakk_chunk.sd.jinja
DOCUMENT_ID_ENDPOINT = (
    f"{VESPA_APP_CONTAINER_URL}/document/v1/default/{{index_name}}/docid"
)

# the default document id endpoint is http://localhost:8080/document/v1/default/zakk_chunk/docid
