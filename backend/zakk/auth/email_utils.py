...
def build_html_email(
    ...
    slack_fragment = ""
    if application_name == ZAKK_DEFAULT_APPLICATION_NAME:
        slack_fragment = f'<br>Have questions? Join our Slack community <a href="{ZAKK_SLACK_URL}">here</a>.'
...
def send_email_with_sendgrid(
    ...
    from_email = Email(mail_from) if mail_from else Email("noreply@digi-trans.org")
...
def send_email_with_smtplib(
    ...
    msg["Message-ID"] = make_msgid(domain="digi-trans.org")
...
def send_subscription_cancellation_email(user_email: str) -> None:
    ...
    cta_link = "https://www.digi-trans.org/pricing"
    ...
    text_content = (
        ...
        "If you change your mind, visit https://www.digi-trans.org/pricing"
    )
    send_email(
        user_email,
        subject,
