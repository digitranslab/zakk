...
class ZakkSalesforce(Salesforce):
    ...
    def get_child_objects_by_id(
        ...
        while True:
            ...
            if len(child_relationships_batch) >= ZakkSalesforce.SOQL_MAX_SUBQUERIES:
                process_batch = True
            ...
            if process_batch:
                ...
                query = ZakkSalesforce._make_child_objects_by_id_query(
                    object_id,
                    sf_type,
