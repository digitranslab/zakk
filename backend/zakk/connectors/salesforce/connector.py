...
class SalesforceConnector(LoadConnector, PollConnector, SlimConnector):
    ...
    def __init__(
        ...
        self._sf_client: ZakkSalesforce | None = None
    ...
    def load_credentials(
        ...
        self._sf_client = ZakkSalesforce(
    ...
    @property
    def sf_client(self) -> ZakkSalesforce:
    ...
    def _load_csvs_to_db(
        csv_directory: str, remove_ids: bool, sf_db: ZakkSalesforceSQLite
    ) -> dict[str, str]:
        """
    ...
    #     parent_types: list[str], sf_client: ZakkSalesforce
    # ) -> set[str]:
    ...
    def _full_sync(
        ...
        sf_db = ZakkSalesforceSQLite(os.path.join(temp_dir, "salesforce_db.sqlite"))
        sf_db.connect()
    ...
    def _make_context(
        ...
        for parent_type in parent_types:
            # parent_zakk_sf_type = ZakkSalesforceType(parent_type, sf_client)
        ...
        for sf_type in all_types:
            # zakk_sf_type = ZakkSalesforceType(sf_type, sf_client)
