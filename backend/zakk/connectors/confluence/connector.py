...
class ConfluenceConnector(
    ...
    def __init__(
        ...
        self._confluence_client: ZakkConfluence | None = None
        self._low_timeout_confluence_client: ZakkConfluence | None = None
    ...
    @property
    def confluence_client(self) -> ZakkConfluence:
        if self._confluence_client is None:
            raise ConnectorMissingCredentialError("Confluence")
        return self._confluence_client

    @property
    def low_timeout_confluence_client(self) -> ZakkConfluence:
    ...
    def set_credentials_provider(
        ...
        low_timeout_confluence_client = ZakkConfluence(
            is_cloud=self.is_cloud,
            url=self.wiki_base,
            credentials_provider=credentials_provider,
            timeout=3,
