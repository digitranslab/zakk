        ...
        **kwargs: Any,
        ...
        with self._credentials_provider:
            ...
            if "confluence_refresh_token" in credentials:
                ...
                oauth2_dict: dict[str, Any] = ZakkConfluence._make_oauth2_dict(
                    credentials
                )
                url = (
    ...
    def _initialize_connection_helper(
        ...
        **kwargs: Any,
        ...
        if "confluence_refresh_token" in credentials:
            ...
            oauth2_dict: dict[str, Any] = ZakkConfluence._make_oauth2_dict(credentials)
...
def get_user_email_from_username__server(
    confluence_client: ZakkConfluence, user_name: str
) -> str | None:
...
def _get_user(confluence_client: ZakkConfluence, user_id: str) -> str:
...
def extract_text_from_confluence_html(
    confluence_client: ZakkConfluence,
