            ...
            if authentication_method == "access_key":
                ...
                def _refresh_credentials() -> dict[str, str]:
                    ...
                    assumed_role_object = sts_client.assume_role(
                        RoleArn=role_arn,
                        RoleSessionName=f"zakk_blob_storage_{int(time.time())}",
                    )
        ...
        for page in pages:
            ...
            for obj in page["Contents"]:
                ...
                try:
                    ...
                    zakk_metadata, custom_tags = process_zakk_metadata(
                        extraction_result.metadata
                    )
                    file_display_name = zakk_metadata.file_display_name or file_name
                    time_updated = zakk_metadata.doc_updated_at or last_modified
