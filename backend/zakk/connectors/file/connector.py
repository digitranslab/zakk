...
def _process_file(
    ...
    zakk_metadata, custom_tags = process_zakk_metadata(metadata)
    file_display_name = zakk_metadata.file_display_name or os.path.basename(file_name)
    time_updated = zakk_metadata.doc_updated_at or datetime.now(timezone.utc)
    primary_owners = zakk_metadata.primary_owners
    secondary_owners = zakk_metadata.secondary_owners
    link = zakk_metadata.link
    ...
    if extraction_result.metadata:
        ...
        zakk_metadata, more_custom_tags = process_zakk_metadata(
        ...
        source_type = zakk_metadata.source_type or source_type
        primary_owners = zakk_metadata.primary_owners or primary_owners
        secondary_owners = zakk_metadata.secondary_owners or secondary_owners
        time_updated = zakk_metadata.doc_updated_at or time_updated
        file_display_name = zakk_metadata.file_display_name or file_display_name
        title = zakk_metadata.title or zakk_metadata.file_display_name or title
        link = zakk_metadata.link or link
