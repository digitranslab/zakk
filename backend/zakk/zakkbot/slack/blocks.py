...
def _build_answer_blocks(
    answer: ChatZakkBotResponse, fallback_answer: str
) -> list[SectionBlock]:
...
def build_slack_response_blocks(
    ...
    """
    # If called with the ZakkBot slash command, the question is lost so we have to reshow it
