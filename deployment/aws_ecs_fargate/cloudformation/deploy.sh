...
INFRA_ORDER=(
  "zakk_efs_template.yaml"
  "zakk_cluster_template.yaml"
  "zakk_acm_template.yaml"
)

# Deployment order for services
SERVICE_ORDER=(
  "zakk_postgres_service_template.yaml"
  "zakk_redis_service_template.yaml"
  "zakk_vespaengine_service_template.yaml"
  "zakk_model_server_indexing_service_template.yaml"
  "zakk_model_server_inference_service_template.yaml"
  "zakk_backend_api_server_service_template.yaml"
  "zakk_backend_background_server_service_template.yaml"
  "zakk_web_server_service_template.yaml"
  "zakk_nginx_service_template.yaml"
)
...
deploy_infra_stacks() {
    for template_name in "${INFRA_ORDER[@]}"; do
      ...
      if [[ "$template_name" == "zakk_acm_template.yaml" ]]; then
