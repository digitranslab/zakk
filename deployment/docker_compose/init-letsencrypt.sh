...
$COMPOSE_CMD -f docker-compose.prod.yml run  --name zakk-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yml -p zakk-stack up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yml -p zakk-stack up --force-recreate -d
